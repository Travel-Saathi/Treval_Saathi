...
export default function DesktopProfile() {
  ...
  return (
    <DesktopLayout
      title="Profile"
      subtitle="Your traveler identity"
      activeKey="profile"
    >
      {loading ? (
        ...
        <View style={styles.row}>
          ...
          <View style={styles.leftColumn}>
            ...
            >
              <View
                style={[styles.identityBand, { backgroundColor: theme.primaryDark }]}
              >
              ...
              <View style={styles.identityBody}>
                ...
                <View style={styles.docGrid}>
                  <View style={styles.docField}>
                    ...
                    <Text style={[styles.docValue, { color: theme.textPrimary }]}>
            ...
            {complete ? (
              ...
              <View
                style={[styles.completeBanner, { backgroundColor: theme.primaryLight }]}
              >
                <Ionicons name="create-outline" size={22} color={theme.primary} />

                <View style={styles.completeTextWrap}>
                  <Text
                    style={[styles.completeTitle, { color: theme.primaryDark }]}
                  >
                    Complete your profile
                  </Text>
                  <Text
                    style={[styles.completeHint, { color: theme.textSecondary }]}
                  >
                ...
                <Pressable
                  ...
                  onPress={() => router.push(ROUTES.editProfile as never)}
                  style={({ pressed }) => [
